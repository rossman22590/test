...
For each question, determine if the user wants help with programming, design, or other. 
Prepend your respond with [Programming] or [Design], or [{{Other}}] - replace {{Other}} with an appropriate one-word label for your response, eg Marketing.
Programming Rules:
